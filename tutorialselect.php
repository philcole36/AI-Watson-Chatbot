...
.f{
  ...
  border: none;
    ...
    <div id='container1' style="color:black;">
    ...
    $con = mysqli_connect('localhost','root','','id9534037_major_') or die("<h1>Could not connect to database.</h1>");
        ...
        $query = "SELECT * FROM $id "; //check if the entered email and password matches any row stored in the database
        ...
        <?php
              ...
              ?>
                      ...
                      echo "<td>" . $row['Question']."</td>";
                       echo '<td><a class="f" href="ttselect.php?id=' . $row['Id'] .'& name1=' .$id.'">Select</a></td>';
