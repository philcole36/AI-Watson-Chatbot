...
.f{
  ...
  border: none;
		...
		<div id='container1'>
				...
				<table >
					<tr>
						<td><h1 style = 'color: black;'>All Tutorials</td>
								  <?php
										  echo '<td><a class="f" href="createtutorial.php?id=' .$TRN. '">ADD</a></td>';
        ...
        <?php
						...
						echo "<td>" . $row['description']."</td>";
							...
							?>
										  ...
										  <?php
										  echo '<td><a class="f" href="tutorial1.php?id=' . $row['fk'] . '">Select</a></td>';
										    echo '<td><a class="f" href="adminfinal.php?Name_t=' . $row['fk'] . '">Delete</a></td>';
